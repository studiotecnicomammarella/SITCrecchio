...
//ol.proj.get("EPSG:6708").setExtent([417985.607493, 4662492.129388, 475170.271714, 4705212.437365]);
var wms_layers = [];
...
var lyr_GoogleStrade = new ol.layer.Tile({
            ...
            source: new ol.source.XYZ({
            attributions: '<a href="https://www.google.at/permissions/geoguidelines/attr-guide.html">Map data ©2026 Google</a> &nbsp&nbsp ',
...
maxResolution:5.600893230452393,
    ...
    creationdate: '2026-06-11 14:41:00',
    interactive: true,
    style: style_Acque,
...
maxResolution:15.870000000000000,
...
maxResolution:28004.466152261964,
 minResolution:15.870000000000000,
...
lyr_OpenStreetMap.setVisible(false);lyr_GoogleStrade.setVisible(false);lyr_GoogleSatellite.setVisible(true);lyr_GoogleIbrido.setVisible(false);lyr_Acque.setVisible(true);lyr_Strade.setVisible(true);lyr_Particelle.setVisible(true);lyr_Fabbricati.setVisible(true);lyr_NumeriParticelle.setVisible(true);lyr_CIVICI.setVisible(true);lyr_SEZIONIDICENSIMENTOISTAT.setVisible(true);lyr_FogliCatastali.setVisible(true);lyr_CONFINECOMUNALE.setVisible(true);lyr_CONFINIISTAT.setVisible(true);
var layersList = [lyr_OpenStreetMap,lyr_GoogleStrade,lyr_GoogleSatellite,lyr_GoogleIbrido,group_CATASTALE,group_TOPONOMASTICA,lyr_FogliCatastali,lyr_CONFINECOMUNALE,lyr_CONFINIISTAT];
...
lyr_CIVICI.set('fieldAliases', {'fid': 'fid', 'COLORE_EXCEL': 'COLORE_EXCEL', 'CODICE_COMUNE': 'CODICE_COMUNE', 'PROGR_NAZIONALE': 'PROGR_NAZIONALE', 'PROGR_STRADA': 'PROGR_STRADA', 'DUG': 'DUG', 'DENOM_COMPLETA': 'DENOM_COMPLETA', 'DENOM_DELIBERA': 'DENOM_DELIBERA', 'CODICE_COMUNALE': 'CODICE_COMUNALE', 'PROGR_CIVICO': 'PROGR_CIVICO', 'CIVICO': 'CIVICO', 'ESPONENTE': 'ESPONENTE', 'SPECIFICITA': 'SPECIFICITA', 'SISTEMA_METRICO': 'SISTEMA_METRICO', 'PROGRESSIVO_SNC': 'PROGRESSIVO_SNC', 'SEZIONE_DI_CENSIMENTO': 'SEZIONE_DI_CENSIMENTO', 'NUM_INTERNI': 'NUM_INTERNI', 'ISOLATO': 'ISOLATO', 'CODICE_CIVICO_COMUNALE': 'CODICE_CIVICO_COMUNALE', 'NON_CONFORMITA': 'NON_CONFORMITA', 'COORDINATA_X': 'COORDINATA_X', 'COORDINATA_Y': 'COORDINATA_Y', 'COORDINATA_Z': 'COORDINATA_Z', 'FLAG_VALIDAZIONE': 'FLAG_VALIDAZIONE', 'METODO': 'METODO', 'DATA_VALIDITA_AMMINISTRATIVA': 'DATA_VALIDITA_AMMINISTRATIVA', 'NUMERO CIVICO': 'NUMERO CIVICO', 'VIA': 'VIA', 'INDIRIZZO': 'INDIRIZZO', 'FOGLIO': 'FOGLIO', 'MAPPALE': 'MAPPALE', 'NOTE_STRADARIO': 'NOTE_STRADARIO', 'CODICE': 'CODICE', 'CARTELLA_KMZ': 'CARTELLA_KMZ', 'SEZIONE DI CENSIMENTO': 'SEZIONE DI CENSIMENTO', });
...
lyr_CIVICI.set('fieldImages', {'fid': 'TextEdit', 'COLORE_EXCEL': '', 'CODICE_COMUNE': 'TextEdit', 'PROGR_NAZIONALE': 'Range', 'PROGR_STRADA': 'Range', 'DUG': 'TextEdit', 'DENOM_COMPLETA': 'TextEdit', 'DENOM_DELIBERA': 'TextEdit', 'CODICE_COMUNALE': 'TextEdit', 'PROGR_CIVICO': 'Range', 'CIVICO': 'Range', 'ESPONENTE': 'TextEdit', 'SPECIFICITA': 'TextEdit', 'SISTEMA_METRICO': 'TextEdit', 'PROGRESSIVO_SNC': 'TextEdit', 'SEZIONE_DI_CENSIMENTO': 'Range', 'NUM_INTERNI': 'CheckBox', 'ISOLATO': 'TextEdit', 'CODICE_CIVICO_COMUNALE': 'TextEdit', 'NON_CONFORMITA': 'TextEdit', 'COORDINATA_X': 'TextEdit', 'COORDINATA_Y': 'TextEdit', 'COORDINATA_Z': 'TextEdit', 'FLAG_VALIDAZIONE': 'CheckBox', 'METODO': 'Range', 'DATA_VALIDITA_AMMINISTRATIVA': 'TextEdit', 'NUMERO CIVICO': 'TextEdit', 'VIA': 'TextEdit', 'INDIRIZZO': '', 'FOGLIO': '', 'MAPPALE': '', 'NOTE_STRADARIO': '', 'CODICE': '', 'CARTELLA_KMZ': '', 'SEZIONE DI CENSIMENTO': 'Range', 'layerObject': 'Hidden', 'idO': 'Hidden'});
...
lyr_Acque.set('fieldLabels', {'fid': 'hidden field', 'Codice_comune': 'hidden field', 'Foglio': 'header label - always visible', 'Mappale': 'header label - always visible', 'Allegato': 'hidden field', 'Sviluppo': 'hidden field', 'Htxt': 'hidden field', 'Rtxt': 'hidden field', 'Xtxt': 'hidden field', 'Ytxt': 'hidden field', });
lyr_Strade.set('fieldLabels', {'fid': 'hidden field', 'Codice_comune': 'hidden field', 'Foglio': 'header label - always visible', 'Mappale': 'header label - always visible', 'Allegato': 'hidden field', 'Sviluppo': 'hidden field', 'Htxt': 'hidden field', 'Rtxt': 'hidden field', 'Xtxt': 'hidden field', 'Ytxt': 'hidden field', });
lyr_Particelle.set('fieldLabels', {'fid': 'hidden field', 'Codice_comune': 'hidden field', 'Foglio': 'header label - always visible', 'Mappale': 'header label - always visible', 'Allegato': 'hidden field', 'Sviluppo': 'hidden field', 'Htxt': 'hidden field', 'Rtxt': 'hidden field', 'Xtxt': 'hidden field', 'Ytxt': 'hidden field', 'CATASTO': 'header label - always visible', });
