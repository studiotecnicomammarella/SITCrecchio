...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:6708',
            //extent: [55296.000000, -2644650.666667, 454642.506882, 4695235.491144],
            units: 'm'
        })
    })
});
...
map.getView().fit([407985.607493, 4652492.129388, 485170.271714, 4715212.437365], map.getSize());
// Scala iniziale 1:100000 — resolution ~35.3 m/px
map.getView().setCenter([446577.939604, 4683852.283377]);
map.getView().setResolution(35.3);
